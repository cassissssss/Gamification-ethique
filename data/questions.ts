...
export const evaluationQuestions: EvaluationQuestion[] = [
  {
    ...
    title: "Où en êtes-vous dans votre réflexion ?",
    type: "radio",
    maxSelections: 1,
    options: [
      { id: "project_open", label: "Aucune mécanique n'a encore été choisie", tags: ["mode_project_open"] },
      { id: "mechanics_envisaged", label: "Une ou plusieurs mécaniques sont déjà envisagées", tags: ["mode_mechanics_envisaged"] },
      { id: "mechanic_requested", label: "Une mécanique est déjà définie", tags: ["mode_mechanic_requested"] },
      { id: "insufficient_info", label: "Nous manquons encore d'informations pour choisir une direction", tags: ["mode_insufficient_info"] },
    ],
  ...
  },
  {
    ...
    note: "Cela peut concerner les rappels, les séries ou les objectifs récurrents. Les conséquences d'une interruption sont abordées dans une question suivante.",
    recommendationEffect: "Déclenche des recommandations sur rappels modérés, streaks et pression temporelle.",
  },
  {
    id: "Q17",
    section: "Temporalité et visibilité",
  ...
  },
  {
    ...
    maxSelections: 1,
    options: [
      { id: "resume_where_left", label: "Il ou elle reprend là où il ou elle s'est arrêté-e, sans changement", tags: ["reprise_continuite"] },
